...
let varTrue = true;
let varFalse = false;
console.log("Q3: The variable I made true is: ", varTrue);
//The output of the above should be true.
console.log("Q3: The variable I made false is: ", varFalse);
...
// PUT YOUR CODE HERE
let x = floatingPoint + integer;
let y = integer + negative;
...
let weirdInitials = firstName[0] + lastName[13];
console.log("Q6", weirdInitials.toUpperCase());
// ---------- QUESTION 7 ----------
...
let answer7 = 10;
if (answer7 >= integer) {
    console.log("Q7: ", varTrue);
} else {
    console.log("Q7: ", varFalse);
}
...
// PUT YOUR CODE HERE
let age = 20;
let number = "Age is just a number!";
let young = "Young at heart";
if (age > 30) {
    console.log("Q8:", number);
} else {
    console.log("Q8:", young);
} if (age < 30) {
    console.log("Q8: ", firstName, ",", number)
} else {
    console.log("Q8: ", firstName + "," + young)
}
...
// PUT YOUR CODE HERE
let exampleNum = 4.4902;
let result = Math.round(exampleNum * 100) / 100;
...
let words = "hello"
console.log("Q14:", useParams(words));
// ---------- QUESTION 15 ----------
...
// PUT YOUR CODE HERE
let word1 = "Today is April";
let word2 = "Tomorrow";

function biggestStringLength(word1, word2) {
    let conv1 = word1.length;
    let conv2 = word2.length;
